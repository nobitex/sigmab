...
circuit/ecdsa_verify_cpp/ecdsa_verify: circuit/ecdsa_verify.r1cs
	mv circuit/ecdsa_verify_cpp/main.cpp circuit/ecdsa_verify_cpp/main.cpp.tmp && python3 scripts/spit_output.py < circuit/ecdsa_verify_cpp/main.cpp.tmp > circuit/ecdsa_verify_cpp/main.cpp && rm circuit/ecdsa_verify_cpp/main.cpp.tmp
	cd circuit/ecdsa_verify_cpp && make
...
ecdsa_verify_witness.wtns: circuit/ecdsa_verify_cpp/ecdsa_verify
	python3 ecdsa_verify.py
	cd circuit/ecdsa_verify_cpp && ./ecdsa_verify ../input.json ../ecdsa_verify_witness.wtns
	# mv circuit/ecdsa_verify_cpp/output.json
	cd circuit/ecdsa_verify_cpp && cat output.json	
