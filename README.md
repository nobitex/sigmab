...
کاربران می‌توانند با استفاده از افزونه کروم/فایرفاکس سیگما-بی، فرایند صحت‌سنجی اثبات‌های ارائه شده توسط صرافی‌ها را انجام دهند. افزونه‌های منتشر شده از کلیدهای صحت‌سنجی شماره `0014` ([لیست مشارکت‌ها](https://github.com/nobitex/sigmab-trusted-setup)) استفاده می‌کنند.
