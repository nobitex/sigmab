...
MPT_LAST_WITNESS_GEN_PATH = os.environ.get(
    ...
    f"{CWD}/circuit/temp/mpt_last/mpt_last_cpp/mpt_last",
)
...
MPT_PATH_WITNESS_GEN_PATH = os.environ.get(
    ...
    f"{CWD}/circuit/temp/mpt_path/mpt_path_cpp/mpt_path",
)
...
ECDSA_WITNESS_GEN_PATH = os.environ.get(
    ...
    f"{CWD}/circuit/temp/ecdsa_verify/ecdsa_verify_cpp/ecdsa_verify",
)
...
SBA_WITNESS_GEN_PATH = os.environ.get(
    ...
    f"{CWD}/circuit/temp/stealth_balance_addition/stealth_balance_addition_cpp/stealth_balance_addition",
)
...
POL_WITNESS_GEN_PATH = os.environ.get(
    ...
    f"{CWD}/circuit/temp/pol/pol_cpp/pol",
)
...
PROVER_PATH = os.environ.get(
    "PROVER_PATH",
    f"{CWD}/circuit/rapidsnark/package/bin/prover",
)
