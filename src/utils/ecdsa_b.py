...
def generate_ecdsa_cicuit_input(signature_data, message, salt, counter):
    ...
    """
    checkECDSA(
        message, signature_data[counter][1], signature_data[counter][0], salt, counter
    )
...
def generate_witness(counter):
    ...
    """
    os.rename(
        f"circuit/temp/ecdsa_verify/input_ecdsa_verify_{counter}.json",
        "circuit/temp/ecdsa_verify/input_ecdsa_verify.json",
    )
    ...
    os.rename(
        "circuit/temp/ecdsa_verify/output_ecdsa_verify.json",
        f"circuit/temp/ecdsa_verify/output_ecdsa_verify_{counter}.json",
    )
    os.rename(
        "circuit/temp/ecdsa_verify/ecdsa_verify_witness.wtns",
        f"circuit/temp/ecdsa_verify/ecdsa_verify_witness_{counter}.wtns",
    )
...
def generate_proof(counter):
    ...
    os.rename(
        "circuit/temp/ecdsa_verify/ecdsa_verify_proof.json",
        f"circuit/temp/ecdsa_verify/ecdsa_verify_proof_{counter}.json",
    )
    os.rename(
        "circuit/temp/ecdsa_verify/ecdsa_verify_public.json",
        f"circuit/temp/ecdsa_verify/ecdsa_verify_public_{counter}.json",
    )
...
def combine_files(counter):
    ...
    for i in range(counter):
        ...
        if os.path.exists(proof_file) and os.path.exists(pub_file):
            ...
            ecdsa_proofs["proofs"].append({"proof": proof_data, "pub": pub_data})
