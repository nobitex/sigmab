...
class MPTPathCircuit(AbstractCircuit):
    ...
    def generate_witness(self, salt, lower, upper, is_top):
        ...
        lowerLayer = list(lower) + (self.MAX_BLOCKS * 136 - len(lower)) * [0]
        upperLayer = list(upper) + (self.MAX_BLOCKS * 136 - len(upper)) * [0]
        ...
        return super().generate_witness(
            ...
            upperLayerBytes=[0] * self.MAX_BLOCKS * 136 if is_top else upperLayer,
