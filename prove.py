...
def get_account_eth_mpt_proof(account, provider):
    ...
    print(mpt_last.get_last_proof(SALT, list(prefixAccountRlp), list(accountRlp)))

get_account_eth_mpt_proof('0x71C7656EC7ab88b098defB751B7401B5f6d8976F', 'https://yolo-shy-fog.discover.quiknode.pro/97f7aeb00bc7a8d80c3d4834a16cd9c86b54b552/')
print("OK!")